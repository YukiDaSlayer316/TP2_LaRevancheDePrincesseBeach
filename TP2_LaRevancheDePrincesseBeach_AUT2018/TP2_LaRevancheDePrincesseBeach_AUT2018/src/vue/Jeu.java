...
controleur.elimineEnnemis(nbEnnemisElimines);*/
    ...
    private void declencherWaveEnnemis() throws SlickException {
        ...
        switch (choixTypeEnnemi) {
            ...
            case 2:
                creerEnnemiAerienDiagonalHaut(nbEnnemis);
                break;

            case 3:
                creerEnnemiAerienDiagonalBas(nbEnnemis);
                break;
            ...
            case 5:
                creerEnnemiAerienCarre(nbEnnemis);
                break;
    ...
    private void creerEnnemiAerienDiagonalHaut(int nbEnnemis) {
        int posY = random.nextInt(HAUTEUR / 16) + 20;
    ...
    private void creerEnnemiAerienDiagonalBas(int nbEnnemis) {
    ...
    private void creerEnnemiAerienCarre(int nbEnnemis) {
